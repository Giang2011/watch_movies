...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
                ...
                // Lấy thông tin user từ Redis CACHE (dùng Hash đơn giản, không qua Jackson)
                UserDetails userDetails = userCacheService.loadUserFromCache(username);

                // Tạo đối tượng Authentication để lưu vào Context
                ...
                // Lưu vào SecurityContext (PHIÊN ĐĂNG NHẬP ẢO CHO REQUEST NÀY)
    ...
    // Hàm phụ: Lấy chuỗi JWT từ Header "Authorization"
